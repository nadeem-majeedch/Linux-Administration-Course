# M17 — Storage, Disks and Filesystems
...
Disks, partitions, filesystems, mounting, fstab with nofail; du/df space audits; the dataset-volume pattern in a snapshot-first lab.
...
- [ ] Prerequisites complete: M12, M16
