...
systemd units, targets, and service lifecycle; read unit files, manage services, create a user service, diagnose failures.
...
- [ ] Prerequisites complete: M18, M19
