...
roadmap: [COURSE-ROADMAP.md — Unit 2 · Command Line Fluency](../../../COURSE-ROADMAP.md#unit-2--command-line-fluency-m05m09).
This page indexes the material; the lessons deliver it.

| Layer | Where |
|---|---|
| Objectives & module contract | [Roadmap](../../../COURSE-ROADMAP.md#unit-2--command-line-fluency-m05m09) + [module README](../README.md) |
